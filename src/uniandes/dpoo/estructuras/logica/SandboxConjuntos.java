...
public class SandboxConjuntos
{
    ...
    {
        return new ArrayList<String>(this.arbolCadenas.descendingSet());
    }	
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
    	...
    	for (String palabra : this.arbolCadenas) {
    		if(palabra.equalsIgnoreCase(cadena) && encontrado == null) {
    			encontrado = palabra;
    		}}
    	if (encontrado != null){
    		this.arbolCadenas.remove(encontrado);
    			}
    ...
    public void reiniciarConjuntoCadenas( List<Object> objetos )
    {
    	...
    	for(Object obj : objetos){
    		this.arbolCadenas.add(obj.toString());
    	}
    }
    ...
    {
    	TreeSet<String> mayus = new TreeSet<String>();
    	for(String palabra: this.arbolCadenas) {
    		mayus.add(palabra.toUpperCase());
    		    	}
    	this.arbolCadenas = mayus;
    }
    ...
    {
        return new TreeSet<String>(this.arbolCadenas.descendingSet());
    }
    ...
    public boolean compararElementos( String[] otroArreglo )
    {
        ...
        {
            if (!this.arbolCadenas.contains(palabra)) {
                return false;      
                }
        }
